...
import { ShieldCheck, Lock, Cpu, LogOut, UserCheck } from 'lucide-react';
    ...
    <div className="min-h-screen w-full bg-[#050505] text-white overflow-hidden flex flex-col items-center justify-center relative selection:bg-purple-500/30 font-sans">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
         {[...Array(40)].map((_, i) => (
           <div 
             key={i} 
             className="absolute rounded-full bg-purple-500/20 shadow-[0_0_5px_rgba(168,85,247,0.4)]"
             style={{
      ...
      <div className="relative z-10 w-full max-w-[480px] p-4">
        <div className="relative bg-[#0a0a0a]/90 backdrop-blur-2xl border border-white/5 rounded-[2.5rem] p-10 md:p-14 flex flex-col items-center shadow-2xl">
          
          {/* Header */}
          <div className="text-center mb-12 relative w-full flex flex-col items-center">
            {!mainLogoError ? (
               <div className="mb-8 relative group">
                  <div className="absolute -inset-10 bg-purple-500/5 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition duration-1000"></div>
                  <img 
                    src="images/logo.png" 
                    alt=""
                    className="h-32 md:h-40 w-auto object-contain relative z-10 drop-shadow-[0_0_35px_rgba(168,85,247,0.1)]"
          ...
          <div className="w-full mb-10">
            {loading ? (
              <div className="flex flex-col items-center gap-4 py-4">
                ...
                <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Verifying Identity</span>
              </div>
            ) : user ? (
              /* User Profile State */
